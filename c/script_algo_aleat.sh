#!/bin/bash
# ce script test le programme avec l'algo de trie aleatoire.
...
./cCalculator -i test.JSON -o example.kml -a algo_aleat #lance l'éxecution du programme avec le fichier d'exemple fournit avec le code source
ls example.kml
