#!/bin/bash
# ce script test le programme avec l'algo de trie alphabétique.
...
./cCalculator -i test.JSON -o example.kml -a algo_alpha #lance l'éxecution du programme avec le fichier d'exemple fournit avec le code source
ls example.kml
